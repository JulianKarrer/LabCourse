...
\begin{titlepage}
  ...
  \begin{center}
    ...
    \begin{figure*}[h!]
      ...
      \caption{The Navier-Stokes momentum equation for incompressible flow. This title page itself is used as a simulation domain in which this equation is solved, highlighting the solver's ability to handle complex boundary conditions and resolve details while maintaining low levels of compression (here: $\rho^{max}_{err}<0.1\%$ for $N>250k$ particles).}
